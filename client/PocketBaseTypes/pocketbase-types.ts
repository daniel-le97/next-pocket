...
export type ChannelsResponse<Texpand = unknown> = ChannelsRecord &
  BaseSystemFields<Texpand>;
export type DirectMessagesResponse<Texpand = unknown> = DirectMessagesRecord &
  BaseSystemFields<Texpand>;
export type FileUploadsResponse<Texpand = unknown> = FileUploadsRecord &
  BaseSystemFields<Texpand>;
export type FriendRequestResponse<Texpand = unknown> = FriendRequestRecord &
  BaseSystemFields<Texpand>;
export type FriendsResponse<Texpand = unknown> = FriendsRecord &
  BaseSystemFields<Texpand>;
export type LikesResponse<Texpand = unknown> = LikesRecord &
  BaseSystemFields<Texpand>;
export type MembersResponse<Texpand = unknown> = MembersRecord &
  BaseSystemFields<Texpand>;
export type MessagesResponse<Texpand = unknown> = MessagesRecord &
  BaseSystemFields<Texpand>;
export type ServersResponse<Texpand = unknown> = ServersRecord &
  BaseSystemFields<Texpand>;
export type TestsResponse<Texpand = unknown> = TestsRecord &
  BaseSystemFields<Texpand>;
export type UsersResponse<Texpand = unknown> = UsersRecord &
  AuthSystemFields<Texpand>;
export type UsersStatusResponse<Texpand = unknown> = UsersStatusRecord &
  BaseSystemFields<Texpand>;
